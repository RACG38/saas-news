...
DOMAIN_NEWS = {"infomoney.com.br", "suno.com.br", "uol.com.br"}

# Variáveis de tempo para execução das funções
MAX_NEWS_DAILY = 5 # Quantidade máxima de notícias diárias por ação
START_FETCH_NEWS = 8 # Inicio do pregão
END_FETCH_NEWS =  18 # Horário após o fim do pregão

PRO_MONITOR_NEWS_INTERVAL_MINUTES = 60
FETCH_AND_SEND_DAILY_NEWS_INTERVAL_HOUR = 18
FETCH_AND_SEND_DAILY_NEWS_INTERVAL_MINUTE = 0
CHECK_DIVIDENDS_DAILY_INTERVAL_HOUR = 8
CHECK_DIVIDENDS_DAILY_INTERVAL_MINUTE = 0
DELETE_PREVIOUS_DAY_NEWS_INTERVAL_HOUR = 0
DELETE_PREVIOUS_DAY_NEWS_INTERVAL_MINUTE = 0
DELETE_STOCKS_INTERVAL_HOUR = 0
DELETE_STOCKS_INTERVAL_MINUTE = 0
DELETE_TOKENS_INTERVAL_HOUR = 0
DELETE_TOKENS_INTERVAL_MINUTE = 0
